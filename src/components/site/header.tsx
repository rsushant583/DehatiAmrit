...
export function SiteHeader() {
  ...
  return (
    <>
      <header
        className={cn(
          "fixed inset-x-0 top-0 z-[85] transition-[background-color,backdrop-filter,border-color,padding,transform] duration-500 [transition-timing-function:var(--ease-silk)]",
          scrolled
